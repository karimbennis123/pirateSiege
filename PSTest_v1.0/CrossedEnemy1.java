 ...
 * 
 */
public class CrossedEnemy1 extends Enemies
{
    GreenfootImage image1 = new GreenfootImage("pirate1_img1.png");
    GifImage gif = new GifImage("pirate1_gif.gif");
    /**
     * Act - do whatever the CrossedEnemy1 wants to do. This method is called whenever the 'Act' or 'Run' button gets pressed in the environment.
     */
    public CrossedEnemy1(){
