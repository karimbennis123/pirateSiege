 ...
 * 
 */
public class CrossedEnemy2 extends Enemies
{
    GreenfootImage image1 = new GreenfootImage("pirate2_img1.png");
    GifImage gif = new GifImage("pirate2_gif.gif");
    /**
     * Act - do whatever the CrossedEnemy2 wants to do. This method is called whenever the 'Act' or 'Run' button gets pressed in the environment.
     */
    public CrossedEnemy2(){
    ...
    protected void cutScene(){
        if(getY() > 326){
            ...
            GreenfootImage straight = new GreenfootImage("Enemy2Straight.png");
